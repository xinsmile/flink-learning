 ...
 * @description 使用 process time
 */
public class CountFlink {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<OrderStatistics> ds_seconds = ks.timeWindow(Time.seconds(2)).apply(new OrderWindowFunction());
